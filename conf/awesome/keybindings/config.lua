...
beautiful.global_keybindings = gears.table.join(beautiful.global_keybindings, {
	...
	awful.key({
		modifiers = {},
		key = "XF86AudioPlay",
		on_press = function() awesome.emit_signal("widget::mpris::keypress", "play_pause") end,
	...
	awful.key({
		modifiers = {},
		key = "XF86AudioPrev",
		on_press = function() awesome.emit_signal("widget::mpris::keypress", "previous") end,
	...
	awful.key({
		modifiers = {},
		key = "XF86AudioNext",
		on_press = function() awesome.emit_signal("widget::mpris::keypress", "next") end,
	...
	awful.key({
		modifiers = {},
		key = "XF86AudioStop",
		on_press = function() awesome.emit_signal("widget::mpris::keypress", "stop") end,
