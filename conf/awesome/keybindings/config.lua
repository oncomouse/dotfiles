...
beautiful.file_explorer = "dotfiles-fm"
-- Default modkey.
...
beautiful.global_keybindings = gears.table.join(beautiful.global_keybindings, {
	...
	awful.key({
		modifiers = {},
		key = "XF86AudioMute",
		on_press = require("widgets.keypress")("dotfiles-media mute", "volume"),
	...
	awful.key({
		...
		on_press = require("widgets.keypress")("dotfiles-media volume down", "volume"),
	...
	awful.key({
		...
		on_press = require("widgets.keypress")("dotfiles-media volume up", "volume"),
