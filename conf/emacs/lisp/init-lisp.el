...
(use-package rainbow-mode
  :straight t
  :hook (((html-mode css-mode conf-mode help-mode) . rainbow-mode)
...

(use-package cl-libify :straight t)


(use-package flycheck-relint :straight t)


(use-package cask-mode :straight t)

;; emacs-lisp local map:
(defvar ap/emacs-lisp-mode-local-map (make-sparse-keymap))
(define-key emacs-lisp-mode-map (kbd "C-c l") ap/emacs-lisp-mode-local-map)
(define-key lisp-interaction-mode-map (kbd "C-c l") ap/emacs-lisp-mode-local-map)
(define-key ap/emacs-lisp-mode-local-map (kbd "e b") #'eval-buffer)
(define-key ap/emacs-lisp-mode-local-map (kbd "e d") #'eval-defun)
(define-key ap/emacs-lisp-mode-local-map (kbd "e e") #'eval-last-sexp)
(define-key ap/emacs-lisp-mode-local-map (kbd "e r") #'eval-region)
(define-key ap/emacs-lisp-mode-local-map (kbd "e l") #'load-library)
(define-key ap/emacs-lisp-mode-local-map (kbd "g f") #'find-function)
(define-key ap/emacs-lisp-mode-local-map (kbd "g v") #'find-variable)
(define-key ap/emacs-lisp-mode-local-map (kbd "g l") #'find-library)

(provide 'init-lisp)
