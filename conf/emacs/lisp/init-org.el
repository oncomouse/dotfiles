...
:hook (org-after-todo-statistics . ap/org-summary-todo)
:hook (org-checkbox-statistics . ap/org-checkbox-todo)
:config
...
(use-package denote
	:straight t
  :hook (emacs-startup . denote-modules-global-mode)
  :config
	(general-define-key :major-modes '(org-mode markdown-mode text-mode)
								:prefix "C-c l n"
								"N" #'denote-type
           "d" #'denote-date
