...
function! dotfiles#autocomplete#nvim_lsp#attach()
	" Key bindings
	...
	set wrapscan
	nnoremap <silent> <Plug>(dotfiles-diagnostic-next) <cmd>lua vim.lsp.diagnostic.goto_next()<CR>
	nnoremap <silent> <Plug>(dotfiles-diagnostic-previous) <cmd>lua vim.lsp.diagnostic.goto_prev()<CR>
endfunction
