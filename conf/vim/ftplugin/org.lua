...
vim.keymap.set("i", "<C-c>.", "<cmd>lua require('orgmode').action('org_mappings.insertmode_date')<cr>", { buffer = true })
vim.keymap.set("i", "<C-c>!", "<cmd>lua require('orgmode').action('org_mappings.insertmode_date','true')<cr>", { buffer = true })
