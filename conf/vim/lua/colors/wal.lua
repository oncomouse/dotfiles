...
function wal.scheme()
	local scheme = {
		...
		Folded = { fg=wal.base03, bg=wal.base01, style="italic" },
		...
		Title = { fg=wal.blue },
		Conceal = { fg=wal.blue, bg=wal.base00 },
		...
		Comment = { fg=wal.base03, style="italic" },
