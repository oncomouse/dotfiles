...
local get_wal_theme = require("colors.wal.utils.wal")
...
function wal.after_scheme()
	local scheme = {
		...
		htmlBold = { fg=wal.yellow, style="bold" },
		htmlItalic = { fg=wal.purple, style="italic" },
		htmlTag = { fg=wal.cyan },
...
function wal.scheme()
	local scheme = {
		...
		Title = { fg=wal.blue, style="bold" },
		Conceal = { fg=wal.base01, bg=wal.base00 },
		...
		LineNr = { fg=wal.base03, bg=wal.base00 },
		...
		CursorLineNr = { fg=wal.base04, bg=wal.base00 },
