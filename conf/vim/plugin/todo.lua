if vim.fn.exists("g:todo_disable") == 0 then
	...
	local function set_maps()
		...
		vim.keymap.set("n", "gt", "<Plug>(todo-toggle-done-motion)", { buffer = true, silent = true, noremap = true })
		vim.keymap.set("x", "gt", "<Plug>(todo-toggle-done-visual)", { buffer = true, silent = true, noremap = true })
		-- Go To Project:
		vim.keymap.set("n", "gtg", "<Plug>(todo-goto-project)", { buffer = true, silent = true, noremap = true })
		-- Search For Done Tasks:
		vim.keymap.set("n", "gt/", "<Plug>(todo-search-done)", { buffer = true, silent = true, noremap = true })
		-- Go To Next Project:
