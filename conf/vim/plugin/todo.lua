if vim.fn.exists("g:enable_todo") == 1 then
	...
	local function set_maps()
		...
		vim.keymap.set("n", "<leader>td", "<Plug>todo-toggle-motion", { buffer = true, silent = true, noremap = true })
		vim.keymap.set("x", "<leader>td", "<Plug>todo-toggle-visual", { buffer = true, silent = true, noremap = true })
		-- Go To Project:
